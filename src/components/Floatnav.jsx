  ...
  return (
    <div
      ...
      >
        ...
        <div class="bg-inherit flex gap-x-4 w-full h-full font-bold py-2 px-4 self-center items-center justify-center rounded-full shadow-lg">
          <a href="tel:+916202908606" >
            <svg
          ...
          {/* mail */}
          <a href="mailto:solcieloinnovacion@gmail.com">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
          ...
          {/* Whatsapp */}
          <a href="https://wa.me/918877666977?text=Query+Tutorsforum">
